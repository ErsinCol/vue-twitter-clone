    ...
    <div class="flex-1">
      <header class="leading-5 flex items-center gap-2 mb-0.5">
          ...
          >
            ...
            <svg v-if="post.account.verified" viewBox="0 0 22 22" class="text-[#1d9bf0] w-[1.172rem] h-[1.172rem] ml-0.5">
              <path
                  fill="currentColor"
      ...
      <div>
        ...
        <div class="flex justify-between -ml-1.5 mt-1.5">
          <div class="group flex items-center gap-px cursor-pointer">
            ...
            <span class="text-[0.813rem] text-[color:var(--color-base-secondary)] group-hover:text-[#1d9bf0] transition-colors">{{numberFormatter(post.stats.comments)}}</span>
          </div>

          <div class="group flex items-center gap-px cursor-pointer">
            <div class="w-[2.172rem] h-[2.172rem] flex items-center justify-center text-[color:var(--color-base-secondary)] group-hover:bg-[#0eb17c1a] rounded-full group-hover:text-[#0eb17c] transition-colors">
              <svg viewBox="0 0 24 24" class="w-[1.172rem] h-[1.172rem]">
                <path
                    fill="currentColor"
            ...
            <span class="text-[0.813rem] text-[color:var(--color-base-secondary)] group-hover:text-[#0eb17c] transition-colors">{{numberFormatter(post.stats.repost)}}</span>
          </div>

          <div class="group flex items-center gap-px cursor-pointer">
            <div class="w-[2.172rem] h-[2.172rem] flex items-center justify-center text-[color:var(--color-base-secondary)] group-hover:bg-[#de2b7f1a] rounded-full group-hover:text-[#de2b7f] transition-colors">
              <svg viewBox="0 0 24 24" class="w-[1.172rem] h-[1.172rem]">
                <path
                    fill="currentColor"
            ...
            <span class="text-[0.813rem] text-[color:var(--color-base-secondary)] group-hover:text-[#de2b7f] transition-colors">{{numberFormatter(post.stats.like)}}</span>
          </div>
          ...
          <div class="group flex items-center gap-px cursor-pointer">
            ...
            <span class="text-[0.813rem] text-[color:var(--color-base-secondary)] group-hover:text-[#1d9bf0] transition-colors">{{numberFormatter(post.stats.view)}}</span>
          </div>
