      ...
      <Disclosure v-slot="{ open }">
        ...
        <DisclosurePanel class="w-full">
          ...
          >
            ...
            <div class="flex-1 text-[15px] font-medium">Analytics</div>
          </RouterLink>
        </DisclosurePanel>
      </Disclosure>
      <Disclosure v-slot="{ open }">
        ...
        <DisclosurePanel class="w-full">
          ...
          >
            ...
            <div class="flex-1 text-[15px] font-medium">Ads</div>
          </RouterLink>
        </DisclosurePanel>
      </Disclosure>
      <Disclosure v-slot="{ open }">
        ...
        <DisclosurePanel class="w-full">
          ...
          >
            ...
            <div class="flex-1 text-[15px] font-medium">Settings and privacy</div>
          </RouterLink>
          <RouterLink
              :to="{ name: 'Home' }"
              class="flex items-center hover:bg-[color:var(--background-secondary)] transition-colors p-3"
          >
            ...
            <div class="flex-1 text-[15px] font-medium">Help center</div>
          </RouterLink>
          <button
          ...
          >
            ...
            <span class="flex-1 text-[15px] font-medium">Display</span>
          </button>
          <RouterLink
              :to="{ name: 'Home' }"
              class="flex items-center hover:bg-[color:var(--background-secondary)] transition-colors p-3"
          >
            ...
            <div class="lex-1 text-[15px] font-medium">Keyboard shortcuts</div>
          </RouterLink>
        </DisclosurePanel>
      </Disclosure>
    </PopoverPanel>
