  ...
  <Popover class="relative">
    <PopoverButton>
      <div class="inline-flex items-center p-3 rounded-full transition-colors hover:bg-[color:var(--background-secondary)]">
        <svg viewBox="0 0 24 24" class="w-[1.641rem] h-[1.641rem]">
          <path
              fill="currentColor"
    ...
    <PopoverPanel
      ...
      >
        <svg viewBox="0 0 24 24" class="w-[1.5rem] h-[1.5rem] mr-[1.5rem]">
      ...
      <Disclosure v-slot="{ open }">
        <DisclosureButton
          ...
          <span class="font-bold">Creator Studio</span>
          <ChevronDownIcon
              :class="{
        ...
        <DisclosurePanel class="w-full">
          ...
          >
            <svg viewBox="0 0 24 24" class="w-[1.172rem] h-[1.172rem] mr-6">
              <path
                  fill="currentColor"
      ...
      <Disclosure v-slot="{ open }">
        <DisclosureButton
            class="flex p-4 cursor-pointer items-center justify-between text-left hover:bg-[color:var(--background-secondary)] transition-colors w-full">
          <span class="font-bold">Professional Tools</span>
          <ChevronDownIcon
              :class="{
                'rotate-180 transform !text-[color:var(--color-primary)]': open,
                'text-current': !open
        ...
        <DisclosurePanel class="w-full">
          ...
          >
            ...
            <div class="flex-1 font-medium">Ads</div>
          </RouterLink>
        </DisclosurePanel>
      </Disclosure>
      <Disclosure v-slot="{ open }">
        <DisclosureButton
            class="flex p-4 cursor-pointer items-center justify-between text-left hover:bg-[color:var(--background-secondary)] transition-colors w-full"
        >
          <span class="font-bold">Settings and Support</span>
          <ChevronDownIcon
              :class="{
                  'rotate-180 transform !text-[color:var(--color-primary)]': open,
                  'text-current': !open
        ...
        <DisclosurePanel class="w-full">
          ...
          >
            ...
            <div class="flex-1 font-medium">Settings and privacy</div>
          </RouterLink>
          <RouterLink
              :to="{ name: 'Home' }"
              class="flex items-center hover:bg-[color:var(--background-secondary)] transition-colors p-3"
          >
            ...
            <div class="flex-1 font-medium">Help center</div>
          </RouterLink>
          <button
          ...
          >
            ...
            <div class="flex-1 font-medium">Keyboard shortcuts</div>
          </RouterLink>
        </DisclosurePanel>
      </Disclosure>
    </PopoverPanel>
