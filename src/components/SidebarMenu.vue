...
<template>
    <nav role="navigation" class="mt-0.5 mb-1">
        <RouterLink :to="{ name: 'Home' }" class="py-1 block group">
            <div class="inline-flex items-center p-3 rounded-full transition-colors group-hover:bg-[#eff3f41a]">
                <svg v-if="!isCurrentRoute('/')" viewBox="0 0 24 24" class="w-[26.25px] h-[26.25px]">
                    <path fill="#e7e9ea"
                ...
                <div class="text-xl pr-4 pl-5 color-[#e7e9ea]">Home</div>
            </div>
        </RouterLink>
        <RouterLink :to="{ name: 'explore' }" class="py-1 block group">
            <div class="inline-flex items-center p-3 rounded-full transition-colors group-hover:bg-[#eff3f41a]">
                <svg v-if="!isCurrentRoute('/explore')" viewBox="0 0 24 24" class="w-[26.25px] h-[26.25px]">
                    <path fill="#e7e9ea"
                ...
                <div class="text-xl pr-4 pl-5 color-[#e7e9ea]">Explore</div>
            </div>
        </RouterLink>
        <RouterLink :to="{ name: 'notifications' }" class="py-1 block group">
            <div class="inline-flex items-center p-3 rounded-full transition-colors group-hover:bg-[#eff3f41a]">
                <svg v-if="!isCurrentRoute('/notifications')" viewBox="0 0 24 24" class="w-[26.25px] h-[26.25px]">
                    <path fill="#e7e9ea"
                ...
                <div class="text-xl pr-4 pl-5 color-[#e7e9ea]">Notifications</div>
        </div>
    </RouterLink>
</nav></template>
