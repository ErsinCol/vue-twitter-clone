...
<template>
    <nav role="navigation" class="mt-0.5 mb-1">
        ...
        <Popover class="relative">
            ...
            <PopoverPanel
                class="absolute z-10 shadow-more -bottom-2 -left-2 bg-black max-h-[calc(100vh - 24.75px)] max-w-[384px] min-w-[318px] overflow-y-auto overflow-x-hidden rounded-xl flex flex-col">
                <RouterLink :to="{name: 'Home'}" class="flex p-4 items-center text-left hover:bg-[#eff3f41a] transition-colors w-full">
